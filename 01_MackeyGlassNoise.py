...
MG_original = MackeyGlass(a = a, b = b, tau = tau, x0 = x0, sample_n = sample_n)
MG = MG_original + np.random.normal(loc=0, scale=np.std(MG_original)*l_noise, size=MG_original.shape)
