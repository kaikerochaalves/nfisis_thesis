...
sample_n = 6000
NTS_original, u_original = Nonlinear(sample_n)
NTS = NTS_original + np.random.normal(loc=0, scale=np.std(NTS_original)*l_noise, size=NTS_original.shape)
u = u_original + np.random.normal(loc=0, scale=np.std(u_original)*l_noise, size=u_original.shape)
...
best_MLP_parameters = {'n_hidden':2, 'n_neurons':87, 'activation':"relu", 'learning_rate': 0.063, 'input_shape': [X_train_DL.shape[1]]}
...
# Set the parameters for the network
best_CNN_parameters = {'n_hidden':2, 'n_neurons':52, 'learning_rate': 0.002}
...
# Set the parameters for the network
best_RNN_parameters = {'n_hidden':4, 'n_neurons':78, 'learning_rate': 3.9e-4}
...
# Set the parameters for the network
best_LSTM_parameters = {'n_neurons':28, 'n_lstm_hidden':2, 'neurons_dense': 0, 'dropout_rate': 0, 'n_dense_hidden':0, 'learning_rate': 0.024}
...
# Set the parameters for the network
best_GRU_parameters = {'filters':32, 'kernel_size':2, 'strides': 1, 'n_neurons': 36, 'n_gru_hidden':4, 'neurons_dense': 0, 'dropout_rate': 0, 'n_dense_hidden': 0, 'learning_rate': 0.016}
...
# Set the parameters for the network
best_WaveNet_parameters = {'dilation_rate':(1,2,4,8,16), 'repeat':2, 'learning_rate': 0.002}
